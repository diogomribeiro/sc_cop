...
inFile = "../source_data/cuomo/G1_CODer_final_dataset_cops_merged_removedoutliers.bed"
#inFile = "../source_data/cuomo/G2M_CODer_final_dataset_cops_merged_removedoutliers.bed"
#inFile = "../source_data/cuomo/S_CODer_final_dataset_cops_merged_removedoutliers.bed"
