...
scGenes = fread("../source_data/cuomo/gprofiler_sc_genes.txt", header = F)
bulkGenes = fread("../source_data/cuomo/gprofiler_bulk_genes.txt", header = F)
backgroundGenes = fread("../source_data/cuomo/gprofiler_background_genes.txt", header = F)
