...
proteinFile = "/mirauta_2020_elife/elife-57390-fig1-data3-v3.xls"
proteinData = fread( proteinFile, stringsAsFactors = FALSE, header = T, sep="\t")

wantedGenes = proteinData$ensembl_gene_id

listDonorRun = fread("../source_data/cuomo/list_donor_runs.txt", stringsAsFactors = FALSE, header = F, sep="\t")

## SINGLE CELL
#copFile = "../source_data/cuomo/sc_CODer_distance_controlled_null.bed"

## BULK
copFile = "./source_data/cuomo/bulk_CODer_distance_controlled_null.bed"
