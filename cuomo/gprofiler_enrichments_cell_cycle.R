...
g1Genes = fread("../source_data/cuomo/gprofiler/G1_genes.txt", header = F)
sGenes = fread("../source_data/cuomo/gprofiler/S_genes.txt", header = F)
g2mGenes = fread("../source_data/cuomo/G2M_genes.txt", header = F)
backgroundGenes = fread("../source_data/cuomo/gprofiler_cycle_background_genes.txt", header = F)
...
#write.table(g2mRes,"g2m_results.tsv", quote=F, row.names=F, sep = "\t")
