...
rnaData = fread("/work/FAC/FBM/DBC/odelanea/glcoex/dribeiro/single_cell/raw_input/share_seq/rna_seq/processing/rep3/binary_nofilt/rep3.rna.counts.ensg.filtered.coding.binary.chr21.bed", sep ="\t")

rnaData = rnaData[start > wantedEnhStart - 500000][end < wantedEnhEnd + 500000]
rnaData[,1:10]

atacData = fread("/work/FAC/FBM/DBC/odelanea/glcoex/dribeiro/single_cell/raw_input/share_seq/atac_seq/processing/rep3_atac_peak_epimap_enhancer_merge_0.5_chr21.bed")
