...
bulk = unique(fread("../data/cuomo2021_bulk_cops_control.bed.gz", stringsAsFactors=F, header=T, sep="\t"))
sc = unique(fread("../data/cuomo2021_sc_cops_final_dataset.bed.gz", stringsAsFactors=F, header=T, sep="\t"))
scInter = unique(fread("../data/cuomo2021_sc_cops_5_or_more.txt.gz", stringsAsFactors=F, header=F, sep="\t"))
